...
1. **providers.json**: `-v ./providers.json:/app/providers.json`
   ...
   - Mounted read-write so `/v1/ui/rules-editor` can persist provider changes
...
2. **models_fallback_rules.json**: `-v ./models_fallback_rules.json:/app/models_fallback_rules.json`
   ...
   - Mounted read-write so `/v1/ui/rules-editor` can persist fallback-rule changes
...
3. Your `models_fallback_rules.json` and `models_operation_rules.json` files reference existing providers and gateway models
